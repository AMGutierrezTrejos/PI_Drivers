    ...
    return (
        <div className='Filters'>
            <select name="DB_And_Api" onChange={handleOrigin} defaultValue=''>
                <option className='option' value="" disabled> Source</option>
            ...
            <select name="Teams" id="teamSelect" onChange={handleTeams} defaultValue=''>
                <option className='option' value="" disabled> Select a team</option>
            ...
            <select name="Date" onChange={handleOrderDate}>
                <option className='option' value="Ascendente">Birth Date Asc</option>
                <option className='option' value="Descendente">Birth Date Desc</option>
            </select>
            <button className='button-reset' onClick={handleResetFilters}>Reset</button>
        </div>
    )
}
